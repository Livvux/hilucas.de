...
export default defineConfig({
  ...
  integrations: [
    ...
    AstroPWA({
      ...
      includeAssets: ["favicon.ico", "livvux-avatar.jpg"],
      manifest: {
        name: "Lucas Kleipödszus",
        short_name: "Livvux",
        description: "Fullstack Developer aus Deutschland. Spezialist für Webdesign, SEO und Open Source.",
        theme_color: "#006cac",
